...
if not defined CONTOOLS_ROOT      call :CANONICAL_PATH CONTOOLS_ROOT      "%%PROJECT_ROOT%%/Tools"
...
if not defined SVNCMD_TOOLS_ROOT  call :CANONICAL_PATH SVNCMD_TOOLS_ROOT  "%%PROJECT_ROOT%%/Scripts"
